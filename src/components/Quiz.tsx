      ...
      <div className="max-w-3xl mx-auto">
        <header className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-4 text-lg">
            Take the Quiz to Find Your AI Readiness Level + Archetype. Get personalized insights into your AI journey and connect with a community of growth-minded women transforming their work and lives.
          </p>
        </header>
