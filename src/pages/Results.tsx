...
const Results = () => {
  ...
  return <div className="min-h-screen bg-background py-12 px-4 pb-10">
      <div className="max-w-4xl mx-auto">
          ...
          <div className="result-card p-8 rounded-xl">
            <div className="text-center mb-6">
              ...
              <div className="mb-4">
                ...
                <Progress value={calculateProgressToNextLevel(result.score, result.levelId)} className="h-2" />
              </div>
            </div>
            <div id="level-blurb" className="text-foreground leading-relaxed text-center">
              {result.levelBlurb.split('\n').map((line, index) => {
              if (line.trim().startsWith('•')) {
                return <div key={index} className="flex items-start justify-start mb-2">
        ...
        <div className="mt-16 text-center space-y-4 hidden">
          <Button id="level-cta" asChild className="bg-secondary text-secondary-foreground hover:bg-secondary-hover border-0 rounded-full text-lg px-8 py-6">
